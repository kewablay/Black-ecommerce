  ...
  return (
    <div className="p-5 rounded-xl">
      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-col gap-2 reciept">
          ...
          <div className="grid grid-cols-12">
            <div className="items-center col-span-8 text-200">
              <p className="font-semibold">Name</p>
              <p className=" text-textGray">{billingInfo.name}</p>
            </div>
            {/*  */}
            <div className="items-center col-span-4 text-200">
      ...
      <div className="grid grid-cols-2 gap-4 mt-5">
        ...
        <button onClick={() => closeModal()} className="text-primary">Continue Editing</button>
      </div>
    </div>
  );
}
